    ...
    <div className="min-h-screen bg-secondary-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md glass rounded-[2rem] p-8 border border-white/10 shadow-2xl">
        <div className="mb-8">
          ...
          <p className="text-secondary-400 text-sm mt-2">Enter your email and the system will prepare a password reset for your portal account.</p>
        </div>
        ...
        {success ? (
          <div className="flex flex-col gap-5">
            <div className="rounded-2xl border border-green-500/20 bg-green-500/10 p-4 text-green-300 flex items-start gap-3">
              ...
              <div>
                <p className="font-bold">Reset requested</p>
                <p className="text-sm mt-1">If the account exists, a reset link will be sent. You can return to the login page once you have it.</p>
              </div>
            </div>
            <Link to="/login" className="inline-flex items-center gap-2 text-primary-400 font-bold hover:text-primary-300">
              <ArrowLeft size={16} />
              Back to login
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label className="text-[11px] font-black uppercase tracking-[0.24em] text-secondary-500">Email Address</label>
