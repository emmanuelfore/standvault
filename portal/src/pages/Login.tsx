      ...
      <div className="w-full max-w-md animate-in relative z-10">
        <div className="flex flex-col items-center gap-4 mb-10">
          ...
          <div className="text-center">
             ...
             <p className="text-secondary-400 font-medium uppercase tracking-[0.2em] text-[10px] mt-1">Purchaser Portal</p>
          </div>
        </div>
        ...
        <div className="glass p-8 md:p-10 rounded-[2.5rem] border-white/10 shadow-2xl">
          <div className="mb-8">
            ...
            <p className="text-secondary-500 text-sm mt-1">Sign in to manage your stand allocation, statements, and payment plan.</p>
          </div>
