    ...
    <div className="min-h-screen bg-secondary-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md glass rounded-[2rem] p-8 border border-white/10 shadow-2xl">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black mt-3">Set Account Password</h1>
          <p className="text-secondary-400 text-sm mt-2">Create a password to activate your account.</p>
        </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="rounded-2xl border border-green-500/20 bg-green-500/10 p-4 text-green-300 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm mt-1">Your account is ready. You can sign in with your email and new password.</p>
              </div>
            </div>
            <Link
              to="/login"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            {!sessionReady && (
              <div className="rounded-2xl border border-orange-500/20 bg-orange-500/10 p-4 text-orange-200 text-sm">
                Open this page from the invitation email so the account session can be verified automatically.
              </div>
            )}
